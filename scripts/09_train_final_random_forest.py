"""Train the final v5 Random Forest pipeline for optional map production.
...
training[cfg.LABEL_COLUMN] = flat_labels[selected]
training["x"] = xs
training["y"] = ys
...
model.fit(training[feature_names], training[cfg.LABEL_COLUMN].astype("uint8"))
...
print("IMPORTANT: this final model is optional continuity output in v5.")
print("It is not the source of ablation holdout evidence.")
print("Use feature_ablation_* outputs from script 08 for scientific comparison.")
